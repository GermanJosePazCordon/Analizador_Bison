...
{
    $2->mostrardatos($2);
}//ejecuto el metodo "ejecutar" del objeto retornado en COMANDOMKDISK
;

COMANDOMKDISK:
    menos psize igual positivo { int tam=atoi($4); obmkdisk *disco=new obmkdisk(); disco->size=tam; $$=disco; }
;

//%type<mdir> COMANDOMKDIR; // lista de instrucciones

//INICIO : LEXP { }

//LEXP:  pmkdir COMANDOMKDIR
//{$2->mostrar($2);}//ejecuto el metodo "ejecutar" del objeto retornado en COMANDOMKDISK


//COMANDOMKDIR:
//menos pspace igual entero {int tam=atoi($4); obmkdir *disc=new obmkdir(); disc->space=tam;  $$=disc;}
